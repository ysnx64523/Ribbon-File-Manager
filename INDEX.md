...
| `src/ribbonfm/app.py` | 191 | RibbonFMApp, main |
...
| `src/ribbonfm/i18n.py` | 189 | _locale_dir, _discover, available_languages, current_language, _make_translator, _candidates, _install_system, os_lang, _windows_lang, init, set_language |
...
| `src/ribbonfm/ui/mainwindow.py` | 492 | MainWindow, _app_version, _size_human, _ts |
...
| `tools/gen_po.py` | 388 | _concat_msgid, _project_version, generate, _parse_quoted, _escape, compile_mo, _ensure_pot, main |
